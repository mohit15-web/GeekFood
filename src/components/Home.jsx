  ...
  return (
    <div className="relative h-[90vh] w-[100vw]">
      ...
      <div className="absolute flex flex-col justify-center items-center w-[30%] top-60 left-60">
        ...
        <h1 className="text-[#E01C48] text-5xl font-extrabold mb-6">Forever Food.</h1>
        <p className="text-[1.1rem] text-center">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nesciunt illo tenetur fuga ducimus numquam ea!</p>
